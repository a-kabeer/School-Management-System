...
from . import affected_timetable_views, class_structure_views, context_views, destructive_views, detail_views, document_views, overview_views, structure_detail_views, timetable_views, views
from .central_create import AcademicsCreateView

app_name = "academics"

urlpatterns = [
    path("", overview_views.AcademicsOverviewView.as_view(), name="overview"),
    path("add/", AcademicsCreateView.as_view(), name="add"),
    path("documents/<slug:document_type>/", document_views.AcademicDocumentView.as_view(), name="document"),
