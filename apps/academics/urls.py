...
urlpatterns = [
    ...
    path("terms/<uuid:pk>/delete/", context_views.TermDeleteView.as_view(), name="term_delete"),
    ...
    path("sections/<uuid:pk>/delete/", context_views.SectionDeleteView.as_view(), name="section_delete"),
